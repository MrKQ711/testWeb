...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="bg-gradient">
            <h3 class=" text-black text-center p-2">Manager Details</h3>
        </div>
        ...
        <div class="row">
            ...
            align-items-center">
                <div class="px-5">
                    <a href="#"><img src="../image/pineappJuice.jpg" alt="" class="admin_image"></a>
                    <p class="text-black text-center">Admin</p>
                </div>
                ...
                <div class="button text-center">
                    ...
                    bg-info my-1">Log out</a></button>
                </div>
            </div>
        </div>

        <!-- fourth child -->
        <!-- If something is exist, then it will display insert_categories.php -->
