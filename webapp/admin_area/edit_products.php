        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_category" class="form-select">
                ...
                while ($row_category_all = mysqli_fetch_assoc($result_category_all)) {
                    ...
                    $categoried_id = $row_category_all['categories_id'];
                    echo "<option value='$categoried_id'>$categories_title</option>";
                };
                ?>
            </select>
        </div>
...
if (isset($_POST['edit_product'])) {
    ...
    if (
        $product_title == '' or $product_desc == '' or $product_keywords == ''
        ...
        $update_product = "UPDATE products SET product_title = '$product_title', product_description = '$product_desc', 
            ...
            product_image3 = '$product_image3', product_price = '$product_price', date = NOW()
