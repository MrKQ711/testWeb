                ...
                <ul class="navbar-nav bg-secondary text-center" style="height: 100vh">
                    <li class="nav-item bg-secondary">
                        <a class="nav-link" href="#">
                            <h4 class="text-black">Your profile</h4>
                        </a>
                    </li>
                    ...
                    $run_user_image = mysqli_query($con, $user_image);
                    $row_image = mysqli_fetch_array($run_user_image);
                    ...
                    <li class="nav-item bg-secondary">
                        <a class="nav-link text-black" href="profile.php">
                            Pending orders
                        </a>
                    </li>

                    <li class="nav-item bg-secondary">
                        <a class="nav-link text-black" href="profile.php?edit_account">
                            Edit account
                        </a>
                    </li>

                    <li class="nav-item bg-secondary">
                        <a class="nav-link text-black" href="profile.php?my_orders">
                            My Orders
                        </a>
                    </li>

                    <li class="nav-item bg-secondary">
                        <a class="nav-link text-black" href="profile.php?delete_account">
                            Delete account
                        </a>
                    </li>
